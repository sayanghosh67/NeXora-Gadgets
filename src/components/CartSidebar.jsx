      ...
      {open && (
        <>
          ...
          <Motion.aside
            ...
            className="fixed right-0 top-0 z-50 flex h-screen w-full max-w-sm flex-col border-l border-blue-400/18 bg-slate-950/96 backdrop-blur-xl shadow-[-8px_0_40px_rgba(2,6,23,0.7)]"
          >
            {/* Header */}
            <div className="flex items-center justify-between border-b border-white/8 px-5 py-4">
              ...
              <button
                type="button"
                onClick={onClose}
                className="rounded-xl border border-white/10 p-2 text-slate-300 transition-colors hover:border-blue-300/40 hover:text-blue-200"
              >
                <X className="size-4" />
              </button>
            </div>
            ...
            <div className="flex-1 space-y-3 overflow-y-auto px-5 py-4">
              <AnimatePresence initial={false}>
                {items.length === 0 ? (
                  ...
                  >
                    <div className="mb-4 flex size-14 items-center justify-center rounded-2xl border border-blue-400/20 bg-blue-500/8 text-blue-400">
            ...
            {items.length > 0 && (
              <div className="space-y-4 border-t border-white/8 px-5 py-4">
                ...
                <div className="flex items-center justify-between border-t border-white/8 pt-3">
                  ...
                  <p className="text-2xl font-bold text-blue-100">{formatINR(price + 199)}</p>
                </div>
